...
def evaluate_ro_tree(input_batch, input_length, generate_nums, encoder, predict, generate, merge, bert,
                  output_lang, num_pos, batch_graph, mat, ori_datas, beam_size=5, english=False, max_length=MAX_OUTPUT_LENGTH):
...
def evaluate_tree(input_batch, input_length, generate_nums, encoder, predict, generate, merge, bert,
